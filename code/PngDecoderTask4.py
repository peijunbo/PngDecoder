...
decompress = list(PNGpicture.decompress_idat())
fillist = []

for i in range(PNGpicture.Height):
    a = decompress.pop(i*PNGpicture.Width*3)
    a = bytes_to_int(a)
    fillist.append(a)
# 建立rgb列表
rlist = []
...
# 更改图片
rlist = [200 for x in range(len(rlist))]
PNGpicture.modify_png(rlist, glist, blist)
